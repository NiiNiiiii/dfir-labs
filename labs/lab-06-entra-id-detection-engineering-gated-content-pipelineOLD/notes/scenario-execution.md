...
- Screenshot: `04_failed_signin_burst_hunt.png`
...
- Screenshot: `05_success_after_failure_hunt.png`
- Correlation IDs: not required for the public write-up
...
- Screenshot: `05_role_assignment_hunt.png`, `10_identity_incident_triggered.png`
...
- Screenshot: `06_sp_credential_addition_hunt.png`
- Correlation IDs: recorded locally during validation and omitted from the public repo
